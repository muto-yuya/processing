...
//楽譜(チューリップ)
int[] ch0={60,62,64,0,60,62,64,0,
           67,64,62,60,62,64,62,0,
           60,62,64,0,60,62,64,0,
           67,64,62,60,62,64,60,0,
           67,67,64,67,69,69,67,0,
           64,64,62,62,60,0,0,0
           };
           
int[] ch1={48,0,0,0,48,0,0,0,
           48,0,0,0,55,0,0,0,
           48,0,0,0,48,0,0,0,
           48,0,0,0,55,0,0,0,
           48,0,0,0,48,0,0,0,
...
void readData() {
  ...
  //1拍の判断
  if(accel[99]-accel[85]>5000&&accel[99]>40000&&fr-p2fr>20){
    i=i+1;
    outwrite.print(",*");
